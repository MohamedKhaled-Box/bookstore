            ...
            <div class="card-body">
                <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="title" class="col-md-4 col-form-label text-md-right">edit book title</label>
                    ...
                    <div class="form-group row">
                        <label for="cover_image" class="col-md-4 col-form-label text-md-right">book image</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="category" class="form-control" name="category">
                                <option disabled {{ $book->category == null ? 'selected' : '' }}>choos category</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="authors" multiple class="form-control" name="authors[]">
                                <option disabled {{ $book->authors()->count() == 0 ? 'selected' : '' }}>choose author
                                </option>
