...
@section('content')
    <a class="btn btn-primary" href="{{ route('publishers.create') }}"><i class="fas fa-plus"></i> أضف تصنيفا جديدًا</a>
    <hr>
    <div class="row">
        <div class="col-md-12">
                ...
                <tbody>
                    @foreach ($publishers as $publisher)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-info btn-sm" href="{{ route('publishers.edit', $publisher) }}"><i
